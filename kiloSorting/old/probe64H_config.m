...
ops.root                = 'D:\ephys\1_openEphysData\PT1_9_28_17\2_presumablyVMHdm\PrabhatStimuli\2017-09-28_22-42-11'; % 'openEphys' only: where raw files are		
...
ops.Nfilt               = 128;           %%%%%%%%%%%%%%%% mhr: CONSIDER INCREASING TO 192 (3X) // THEM: number of clusters to use (2-4 times more than Nchan, should be a multiple of 32)     		
...
ops.chanMap             = 'C:\Users\ephys\Documents\MHR_optoEphys_cntrl\probe64H_chanMap.mat'; % make this file using createChannelMapFile.m		
