function oe2dat(oe_path,save_dir,sync_channel,sync_input)
...
outFile = [save_dir filesep 'ephys.dat'];
fid = fopen(outFile, 'w');
...
switch sync_input
    ...
    case 'ttl'
        ...
        outFile = [save_dir filesep 'sync.mat'];
    ...
    case 'adc'
        ...
        outFile = [save_dir filesep 'sync.dat'];
        fid = fopen(outFile, 'w');
...
param_filename = [save_dir filesep 'dat_params.txt'];
